...
{
    public function it_detects_voiding_verbs(): void
    {
    ...
    public function its_display_property_is_null_if_omitted(): void
    {
        $iri = IRI::fromString('http://tincanapi.com/conformancetest/verbid');
    ...
    public function it_creates_voiding_verb_through_factory_method(): void
    {
    ...
    public function it_is_different_when_displays_are_omitted_and_other_verb_contains_an_empty_list_of_displays(): void
    {
    ...
    public function it_is_equal_when_verb_id_is_equal_and_display_values_are_omitted(): void
    {
        $this->beConstructedWith(IRI::fromString('http://tincanapi.com/conformancetest/verbid'));
