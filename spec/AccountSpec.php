...
class AccountSpec extends ObjectBehavior
{
    ...
    public function it_is_not_equal_to_other_account_if_name_are_not_equal(): void
    {
    ...
    public function it_is_not_equal_to_other_account_if_home_pages_are_not_equal(): void
    {
        $this->beConstructedWith('test', IRL::fromString('https://tincanapi.com'));
    ...
    public function it_is_equal_to_other_account_if_all_properties_are_equal(): void
    {
        $this->beConstructedWith('test', IRL::fromString('https://tincanapi.com'));
