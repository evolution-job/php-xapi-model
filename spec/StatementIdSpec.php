...
{
    public function it_can_be_created_from_a_uuid(): void
    {
    ...
    public function it_should_reject_malformed_uuids(): void
    {
        $this->beConstructedThrough('fromString', ['bad-uuid']);
        $this->shouldThrow(InvalidArgumentException::class)->duringInstantiation();
    }

    public function its_value_is_a_uuid_string(): void
    {
        $this->beConstructedThrough('fromUuid', [Uuid::fromString('39e24cc4-69af-4b01-a824-1fdc6ea8a3af')]);
    ...
    public function it_is_equal_to_statement_ids_with_equal_value(): void
    {
